...
대표 페이지에만 표시되는 비클릭 계획 카드입니다. 연구와 제품 개발이 완료되면 상세 기록의 진입점으로 전환할 예정입니다.

1. **LED 모션캡처 기반 드론 비행경로 제어 시스템**
...
3. **신규 카메라 모듈 제품 케이스 제작**
   ...
   - 미리보기는 카메라 케이스 설계를 위해 직접 제작한 단순화된 비기능성 3D 더미 모델이며, 실제 회로 및 PCB 설계 정보는 포함하지 않습니다.
   - 목표: 2026.08
